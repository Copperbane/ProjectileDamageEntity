...
{
    public partial class ProjectileDamageEntityV2 : MissileDamageEntity
    {
        ...
        protected override void FixedUpdate()
        {
            ...
            for (float step = 0; step < 1; step += stepSize)
            {
                ...
                if (Physics.Raycast(point1, point2 - point1, out hit, missileSpeed * Time.deltaTime, hitLayers))
                {
                    ...
                    if (hit.transform.GetComponent<DamageableHitBox>() && hit.transform.GetComponent<DamageableHitBox>().CurrentHp <= 0)
                    {
                        point1 = point2;
                        continue;
                    }
